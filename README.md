...
After the repository is published on GitHub, change to the target project and use the [existing `skills` CLI](https://github.com/vercel-labs/skills/blob/main/README.md), just as you would for other skills:

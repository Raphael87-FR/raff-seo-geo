...
- Explain the exact claim the source supports and why it applies here. Keep contradicted claims, benefits not established, and inapplicable tactics distinct. Do not generalize one engine's rule to every service.
